    ...
    <div>
        <div>
            <el-row>
                ...
                <el-col :span="3">
                    <el-button type="primary" @click="everyStepInOrder">逐步获取结果</el-button>
                </el-col>
                <el-col :span="3">
                    <el-button type="primary" @click="onceInOder">直接获取结果</el-button>
                </el-col>
                <el-col :span="3">
                    <div>中序遍历演示</div>
                </el-col>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             * @param rightSon
             */
            drawInOrder(data,parent, leftSon, rightSon) {
                this.initRect();
                this.inOrderRes();
            ...
            everyStepInOrder() {
                ...
                if (this.traverRes.length >= this.data.length) {
                    //进行最后一次渲染
                    this.graph.clearCanvas(ctx);
                    this.drawInOrder(this.data, this.parentIndex,[],[]);
                    console.log('结束了')
                    return;
                }
                //清空画布
                this.graph.clearCanvas(ctx);
                //画二叉树
                this.drawInOrder(this.data,  this.parentIndex, leftSon, rightSon);
