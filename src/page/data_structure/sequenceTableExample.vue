    ...
    export default {
        ...
        methods:{
            addItem(){
                ...
                this.textShowIndex = this.dataList.length-1 + '';
                this.initCanvas();
                this.textAdd = '';
            ...
            spliceItem(){
                ...
                if(this.indexDel < this.dataList.length){
                    this.textShow = this.dataList[this.indexDel];
                    this.dataList.splice(this.indexDel, 1);
            ...
            findItem(){
                ...
                if(this.indexFind >= 0){
                    ...
                    this.textShowIndex = this.indexFind + '';
                    this.initCanvas();
            ...
            initCanvas(){
                ...
                for (let i = 0; i < this.dataList.length; i++) {
                    ...
                    //换行
                    ctx.strokeRect(40 * (1 + i % coloum) + 4*(i % coloum), 40 * (1+j*2), 40, 40);

                    //下标
                    ctx.fillText(i+'', 40 * (1 + i % coloum) + 4*(i % coloum) + 20, 40 * (1+j*2) + 55);

                    //数值
                    ctx.fillText(this.dataList[i], 40 * (1 + i % coloum) + 4*(i % coloum) + 20, 40 * (1+j*2) + 25);
