...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             * @param rightSon
             */
            drawMaxHeap(data, parent, leftSon, rightSon) {
                this.initRect();
            ...
            everyStepHeap() {
                ...
                this.graph.clearCanvas(ctx);
                //画二叉树
                this.drawMaxHeap(this.dataInt, this.parent, this.leftSon, this.leftSon + 1);
            ...
            next(isNext) {
                ...
                if (this.leftSon >= this.dataInt.length || isNext) {
                    ...
                    if (this.startIndex < 0) {
                        ...
                        this.graph.clearCanvas(ctx);
                        //画二叉树
                        this.drawMaxHeap(this.dataInt, -1, -1, -1);
